...
export abstract class BaseDevice {
   ...
   * @param param 参数
   */
  abstract chooseContactsAsync(
    param?: ContactUserParam
  ): Promise<Array<ContactUser>>;
   ...
   * @param param 参数
   */
  abstract userLocationAsync(
    param?: MediaLocationParam
   ...
   * @param param 参数
   */
  abstract userLocationWifiAsync(
   ...
   * @param param 参数
   */
  abstract faceCollectionAsync(
    param?: FaceCollectionParam
   ...
   * @param param
   */
  abstract openReadWithTimer(
    param?: ReadWithNumberParam
  ): Promise<ReadWithNumber>;
